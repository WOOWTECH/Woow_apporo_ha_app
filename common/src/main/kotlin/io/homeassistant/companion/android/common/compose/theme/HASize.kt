 ...
 * Apporo VI System mandates 20px (X2L) as the standard corner radius.
 */
object HARadius {
    /** Square radius (0dp). */
    val Square = 0.dp
    ...
    /** Extra extra large radius (20dp, equivalent to 1.25rem). Apporo VI Standard. */
    val X2L = 20.dp

    /** Standard radius - Apporo VI compliant (20dp). Use this for all cards, buttons, containers. */
    val Standard = X2L
